...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '945e0cc3ef8a4ad49c6f7b9a24c4bdf8,en:afb5870f6052438082917016a504422f',
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个小猫咪, Hi，我是一个大老虎,Hi，我是一个学习咪,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'NotionNext', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个熟练使用智能设备的小猫🐱', // 作者简介
